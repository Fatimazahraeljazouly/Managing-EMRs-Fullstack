...
if($_SERVER["REQUEST_METHOD"]=="POST" && isset($_POST["login"])){
    ...
    $sql = "SELECT s.idSec, u.motdepasse, u.username FROM secretaire s JOIN utilisateur u ON u.idUtilisateur = s.idUtilisateur WHERE u.username = ?";
...
<body>
    <div class="container d-flex align-items-center justify-content-center min-vh-100">
        <div class="card login-card p-4">
            <div class="card-body">
                <img   src="../icons/secritaireIcon.png" alt="" style="margin-left: 40%;">
                <h2 class="text-center mb-4">Connexion Secrétaire</h2>
                <hr>
